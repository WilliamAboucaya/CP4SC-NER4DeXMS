package org.zefxis.dexms.dex.protocols.{protocol_name};
...
public class Mediator{Protocol_Name}Subcomponent extends MediatorGmSubcomponent {{
    ...
    public Mediator{Protocol_Name}Subcomponent(MediatorConfiguration bcConfiguration,	GmServiceRepresentation serviceRepresentation) {{
